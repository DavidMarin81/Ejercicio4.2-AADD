CREATE OR REPLACE TYPE person_dir_typ AS OBJECT (
  ...
  MEMBER PROCEDURE setDireccion (direccion direccion_typ),
...
CREATE OR REPLACE TYPE BODY person_dir_typ AS
    ...
    MEMBER PROCEDURE display_details ( SELF IN OUT NOCOPY person_dir_typ ) AS
        ...
        END;
    MEMBER PROCEDURE setDireccion (direccion direccion_typ) AS
        BEGIN
            SELF.direccion := direccion;
        END; 
    MEMBER FUNCTION getDireccion RETURN direccion_typ AS
        BEGIN
            RETURN direccion;
        END;
END;
